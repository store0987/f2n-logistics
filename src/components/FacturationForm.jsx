...
const LOGISTICS_DESIGNATIONS = [
  ...
  "Honoraires de Transit Import",
  "Honoraires de Transit Export",
  "Magasinage Portuaire (DPW)",
  "Manutention (Terre-Plein/Quai)",
  "Passage Portuaire (BAD)",
  "Émission Bon à Délivrer (BAD)",
  "Frais de Timbre Fiscal",
  "Redevance Statistique (RS)",
  "Prélèvement Communautaire (PCC/PCS)",
  "Taxe COSEC",
  "Visite Douane / Inspection",
  "Scanner Portuaire",
  "Frais de Scellé Douane",
  "Escorte Douanière",
  "Surestaries Armateur",
  "Détention Conteneur",
  "Immobilisation Véhicule",
  "Transport Local (Camion)",
  "Livraison Hors Ville",
  "Traction Portuaire",
  "Déchargement / Dépotage",
  "Chargement / Empotage",
  "Magasinage Sous Douane",
  "Frais LTA / Master BL",
  "Correction de Manifeste",
  "Assurance Faculté (Transport)",
  "SGS / Bureau Veritas / Cotecna",
  "Expertise Marchandise",
  "Fumigation / Certificat Phytosanitaire",
  "Suivi Logistique & Reporting",
  "Frais d'Agence",
  "Messagerie et Courrier (DHL/UPS)",
  "Palettisation et Filmage",
  "Location de Grue / Élévateur",
  "Frais de Pesage (VGM)",
  "Droits et Taxes Douaniers",
  "Cautionnement Conteneur",
